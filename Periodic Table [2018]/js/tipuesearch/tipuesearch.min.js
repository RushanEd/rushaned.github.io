...
{if(l_o>=start&&l_o<set.show+start)
     var str=tipue_search_w+found[i].title;
     var e=eval(str);
{out+='<a class="searchRes" href="https://en.wikipedia.org/wiki/'+e.name+'"><left><box style="background:'+eval(e.classification).color+';"><i>'+(Number(str.slice(1))+Number(e.neutrons))+'</i><b>'+str.slice(1)+'</b><h1>'+e.symbol+'</h1></box></left><right><d>'+e.name+' </d><div class="description">'+e.name+ "'s classification is "+eval(e.classification).name+". It's atomic number is "+str.slice(1)+". It was discovered by "+e.disBy+" in "+e.yearDis+". "+e.name+"'s melting point is "+e.liquidIn+" and it's boiling point is "+e.gasIn+". <t style='float:right;'><i class='fab fa-wikipedia-w'></i></t></div></right></a>";if(set.debug)
...
{t_d+='';}
t_d=t_d.replace(/h0011/g,'span class=\"tipue_search_content_bold\"');t_d=t_d.replace(/h0012/g,'/span');out+='';}}
l_o++;}
